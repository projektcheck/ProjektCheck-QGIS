...
<qgis styleCategories="Symbology|Labeling" version="3.10.1-A Coruña" labelsEnabled="1">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="fillColor">
                  ...
                  <Option type="QString" value="coalesce(ramp_color(create_ramp(map(0,'#67000d',0.13,'#a50f15',0.26,'#cb181d',0.39,'#ef3b2c',0.52,'#fb6a4a',0.65,'#fc9272',0.78,'#fcbba1',0.9,'#fee0d2',1,'#fff5f0')),scale_linear(IF (&quot;umsatzsteuer&quot; > 0, NULL, &quot;umsatzsteuer&quot;), minimum(&quot;umsatzsteuer&quot;), 0, 0, 1)), '#238b45')" name="expression"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontItalic="0" fontSize="8" fontWordSpacing="0" blendMode="0" fontStrikeout="0" namedStyle="Standard" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fieldName=" format_number(round( &quot;umsatzsteuer&quot;),0) || '€'" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" textColor="0,0,0,255" fontWeight="50" fontCapitals="0" textOpacity="1" fontUnderline="0" textOrientation="horizontal" isExpression="1" fontKerning="1" multilineHeight="1">
