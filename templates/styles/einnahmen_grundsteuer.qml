...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.10.3-A Coruña">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="fillColor">
                  ...
                  <Option type="QString" name="expression" value="coalesce(ramp_color(create_ramp(map(0,'#67000d',0.13,'#a50f15',0.26,'#cb181d',0.39,'#ef3b2c',0.52,'#fb6a4a',0.65,'#fc9272',0.78,'#fcbba1',0.9,'#fee0d2',1,'#fff5f0')),scale_linear(IF (&quot;grundsteuer&quot; >= 1, NULL, &quot;grundsteuer&quot;), minimum(&quot;grundsteuer&quot;), 1, 1, 1)), '#238b45')"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Standard" fontItalic="0" fontCapitals="0" fontSizeUnit="Point" blendMode="0" textColor="0,0,0,255" fontWordSpacing="0" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" fontSize="8" textOpacity="1" multilineHeight="1" fontKerning="1" isExpression="1" useSubstitutions="0" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" fontUnderline="0" fontStrikeout="0" fieldName="IF (format_number(round( &quot;grundsteuer&quot;),0) = 0, &quot;GEN&quot; || '\\' || '±' || format_number(round( &quot;grundsteuer&quot;),0) || ' €', &#xd;&#xa;&#x9;IF (format_number(round( &quot;grundsteuer&quot;),0) > 0, &quot;GEN&quot; || '\\' || '+' || format_number(round( &quot;grundsteuer&quot;),0) || ' €',&#xd;&#xa;&#x9;&#x9;&quot;GEN&quot; || '\\' || format_number(round( &quot;grundsteuer&quot;),0) || ' €'))" fontFamily="MS Shell Dlg 2">
